...
## What is included?
- Pairs well with [cobra](github.com/spf13/cobra) and [viper](github.com/spf13/viper) via [fangs](github.com/boss-net/fangs), covering CLI arg parsing and config file + env var loading.
...
- Provides a logger via the [logger interface](github.com/boss-net/go-logger), allowing you to swap out for any concrete logger you'd like.
